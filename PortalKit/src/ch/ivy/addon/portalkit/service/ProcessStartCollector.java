...
public class ProcessStartCollector {
  ...
  private static final String EXPRESS_WORKFLOW_EXPORT_REQUEST_PATH =
	      "Start Processes/Export/startExpressWfExport.ivp";
  ...
  public String findExpressWorkflowExportLink(String workflowId) {
	    String url = ProcessStartAPI.findRelativeUrlByProcessStartFriendlyRequestPath(EXPRESS_WORKFLOW_EXPORT_REQUEST_PATH);
	    if (StringUtils.isNotBlank(url)) {
	      return  String.format("%s?workflowID=%s", url, workflowId);
	    }
	    return StringUtils.EMPTY;
